...
--
-- Host: 127.0.0.1
-- Generation Time: 29 Jul 2016 pada 12.54
-- Versi Server: 5.6.24
-- PHP Version: 5.6.8
...
INSERT INTO `berkas` (`id`, `nama`, `format`, `mime`, `status`, `user_id`, `delete_stat`) VALUES
(1, '1469676187-seinal51@gmail.com-.berkas.php-.php', 'php', 'application/octet-stream', '', 23, 1),
(2, '1469676233-seinal51@gmail.com-.User.php-.php', 'php', 'application/octet-stream', '', 23, 1),
(3, '1469775091-seinal51@gmail.com-.1-5-1-PB (1).pptx-.pptx', 'pptx', 'application/vnd.openxmlformats-officedocument.pres', '', 23, 0),
(4, '1469779562-seinal51@gmail.com-.Desert.jpg-.jpg', 'jpg', 'image/jpeg', '', 23, 0),
(5, '1469779566-seinal51@gmail.com-.Hydrangeas.jpg-.jpg', 'jpg', 'image/jpeg', '', 23, 0);
...
INSERT INTO `data_pribadi` (`id`, `no_anggota`, `nama`, `tempat_lahir`, `tanggal_lahir`, `no_ktp`, `npwp`, `no_registrasi`, `jenis_kelamin`, `agama`, `alamat_provinsi`, `alamat`, `rt`, `rw`, `kelurahan`, `kecamatan`, `alamat_pos`, `email`, `telp`, `fax`, `hp`, `foto`, `foto_mime`, `perusahaan`, `perusahaan_alamat`, `perusahaan_jabatan`, `perusahaan_korespondensi`, `perusahaan_telp`, `perusahaan_extensi`, `perusahaan_fax`, `perusahaan_level`, `perusahaan_kategori`, `perusahaan_tipe`, `perusahaan_bisnis`, `user_id`) VALUES
...
(22, '', 'sein al aaa', ' kota pekanbaru', '2016-07-12', 'Hussein Al-muhtadee', '10001', '2010123', 'Pria', 'Islam', 'Nanggroe Aceh Darussalam', 'asdasd', '', '', '', '', 'asdasd', 'seinal51@gmail.com', '', '', '123213', '1469784124-seinal51@gmail.com-profile.jpg', 'image/jpeg', 'bintang permata1', '', 'ok', 'Kantor', '1900211', '    09123', '876234', 'Senior Management', 'Akuntan Sektor Publik', '0', 'Asuransi', 23);
...
(7, 'PT Bahagia', 'slaes', 'marketing', '2016-07-07', '2016-08-05', 24, '123 ok', 23, 0);
...
INSERT INTO `pembayaran` (`id`, `user_id`, `jenis`, `tanggal`, `jumlah`, `lokasi`, `no_kwitansi`, `bank_penerima`, `bank_pengirim`, `rekening_pengirim`, `pemegang_rekening`, `bukti_transfer`, `mime`) VALUES
(1, 0, 'transfer', '0000-00-00', 0, '', '', 'Bank Mandiri Jakarta (123 123456 1234)', 'sein', '1231231', 'tes', '', ''),
(2, 0, 'transfer', '0000-00-00', 125000, '', '', 'Bank BCA Jakarta (9876533222)', 'sein', '1231231', 'tes', '', ''),
(3, 0, 'transfer', '0000-00-00', 125000, '', '', 'Bank Mandiri Jakarta (123 123456 1234)', 'sein', '1231231', 'tes', '1469789124-seinal51@gmail.com-transfer.jpg', 'image/jpeg'),
(4, 0, 'kasir', '0000-00-00', 125000, 'Bali', '9909898908', '', '', '', '', '', '');
...
(3, '2016-07-15', '2016-07-14', 'Ekonomi', 'DIII', 'Jakarta', 23, 0),
...
(7, '0000-00-00', '', '', 'SMA atau sederajat', '', 23, 1),
(8, '0000-00-00', '', '', 'SMA atau sederajat', '', 23, 1),
(9, '0000-00-00', '', '', 'SMA atau sederajat', '', 23, 0);
...
(4, 23, 7, 'by9y1c6B4uKYGfw', 'kvVikpmWuX8K2yC', '2016-07-22');
...
(3, '2016-06-04', '123', 'asdf123', 'asdfsdf lala', 23, 0);
...
(23, 'seinal51@gmail.com', 'seinal51@gmail.com', '$2y$10$X3FTz6I4CmSCKmlz2FcRQe0v6XztCNN/5gBjmgPtsnRp3dcGiOyiq', 'member', 1, '2018-01-01', 0, 'Ihg2xFhuBaUxJYuoUKTSn5yTp5t0uVogJT4636XkzUBaxRzVqYp3z8EhKPGv', 0);
